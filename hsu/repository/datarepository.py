    ...
    def populate_table_models_active(conn):
        ...
        try:
            if conn is not None:
                ...
                sql4 = ''' INSERT INTO models_active(location_id, model_id) VALUES(4, 12) '''
        ...
        try:
            if conn is not None:
                ...
                sql7 = ''' INSERT INTO workflow_steps(name, sequence_number, type, workflow_id, location_id, model_id)
                           VALUES('WORKFLOW_2_STEP_4', 4, 2, 2, 4, 12) '''
    ...
    def populate_table_workflow_rules(conn):
        ...
        try:
            if conn is not None:
                ...
                sql3 = ''' INSERT INTO workflow_rules(workflow_id, condition, model_id_value, stop_conditions) VALUES(2, '1', 'predicted_temp[12]', 0) '''
